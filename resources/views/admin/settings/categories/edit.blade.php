...
@section('title')
{{__('admin/categories.edit_categorie')}}
@endsection
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> {{__('admin/categories.edit_categorie')}} - {{$category -> name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="box-content">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin/categories.edit_categorie')}} </h4>
                                </div>
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.settings.categories.update',$category -> id)}}"
                                              method="POST"
                                                    ...
                                                    <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label for="projectinput1"> {{__('admin/categories.description')}}</label>
                                                                        <textarea type="text" value="" id="name" class="form-control"
                                                                        placeholder=" " name="description">{{$category->matricule}}</textarea>
                                                                    @error("description")
                                                                    <span class="text-danger"> {{$message}}  </span>
                                                                    @enderror
                                                                </div>
