...
@section('title')
{{__('admin/navBar.partialy_paid_invoices')}}
@endsection
@section('content')
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{__('admin/navBar.partialy_paid_invoices')}}
                                    </li>
                                </ol>
                            </div>
                        </div>
                ...
                <div class="box-content">
                    <div class="row">
                        <div class="col-xs-12 col-md-12 col-sm-6 col-lg-6">
                            <h4 class="box-title">{{__('admin/navBar.partialy_paid_invoices')}}</h4>
                        </div>
                        <div class="col-xs-12 col-md-12 col-sm-6 col-lg-6">
